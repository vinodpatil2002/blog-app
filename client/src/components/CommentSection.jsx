  ...
  return (
    <div className='max-w-2xl mx-auto w-full p-3'>
        ...
        {comments.length === 0 ? (
            ...
            <>
                <div className='gap-2 text-sm my-5  flex items-center'>
                    <p>Comments</p>
                    <div className="border border-gray-400 py-1 px-2 ">{comments.length}</div>
                </div>
                {comments.map(comment =>(
                    <Comment key={comment._id}
                    comment={comment} onEdit={handleEdit} onLike={handleLike} onDelete={
                        (commentId) => {
                            setShowModal(true)
